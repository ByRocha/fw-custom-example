# Auto-generated board.mk for urutau0.3
...
DDEFS += -UEFI_CAN_SUPPORT -DEFI_CAN_SUPPORT=TRUE
DDEFS += -UEFI_USB_SERIAL -DEFI_USB_SERIAL=TRUE
DDEFS += -UEFI_SD_CARD -DEFI_SD_CARD=TRUE
