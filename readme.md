...
## Base
Esta firmware é compilada **sobre a board upstream `urutau03`** (pasta `firmware/config/boards/urutau03` do submódulo rusefi).
...
## Arquivos no pacote
- `meta-info.env` — identificação (SHORT_BOARD_NAME=urutau03 / PROJECT_CPU=ARCH_STM32F4)
